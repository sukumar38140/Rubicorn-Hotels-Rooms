...
function renderAdminLogin(container) {
  ...
  container.innerHTML = `
    <div class="admin-login-card fade-in-up-anim">
      <div style="margin-bottom:1.5rem;"><img src="assets/logo.png?v=4.3" alt="Rubicorn Logo" style="height:80px; object-fit:contain; filter:drop-shadow(0 0 5px rgba(201, 168, 76, 0.35));"></div>
  ...
  mainDiv.innerHTML = `
    ...
    <aside class="admin-sidebar">
      <div class="admin-sidebar-header" style="text-align:center; padding-bottom:1rem; border-bottom:1px solid var(--color-card-border); width: 100%;">
        <img src="assets/logo.png?v=4.3" alt="Rubicorn Logo" style="height:60px; object-fit:contain; margin-bottom:0.5rem; filter:drop-shadow(0 0 4px rgba(201, 168, 76, 0.35));">
